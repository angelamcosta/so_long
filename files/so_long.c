...
/*   Updated: 2023/02/13 16:30:13 by anlima           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	events(int keycode)
{
	...
	{
		if ((keycode == 65363 || keycode == 100) && (create_win()->x + 32 <= 448))
			create_win()->x += 32;
		if ((keycode == 65361 || keycode == 97) && (create_win()->x - 32 >= 0))
			create_win()->x -= 32;
		if ((keycode == 65364 || keycode == 115) && (create_win()->y + 32 <= 448))
			create_win()->y += 32;
		if ((keycode == 65362  || keycode == 119) && (create_win()->y - 32 >= 0))
			create_win()->y -= 32;
